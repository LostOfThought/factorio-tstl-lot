...
async function main() {
  try {
    logInitialMessage("--- Initializing Packaging Process ---", "Starting unified mod packaging process (orchestrator)...\\n");
    ...
    let manageVersionArgs = [manageVersionToolPath, packageJsonPath];
    ...
    const finalModVersion = versionLines[versionLines.length - 1].trim();
